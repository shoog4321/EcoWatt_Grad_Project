        ...
        children: [
          Row(
            children: [
              const Text(
                'Current Month Bill',
                style: TextStyle(color: ecowattGray, fontSize: 14),
              ),
              const Spacer(),
              Container(
                padding:
          ...
          GestureDetector(
            ...
            child: Stack(
              children: [
                ...
                // هنا التعديل: بوكس المقارنة صار بالنص
                if (selectedBar != null)
                  Positioned(
                    top: 35,
                    left: 0,
                    ...
                    child: Center(
                      child: _ChartTooltip(
                        title: selectedBar == 'home'
                            ? 'Your Home'
                            : 'Similar Homes',
                        value: selectedBar == 'home'
                            ? 'consumption : 650'
                            : 'consumption : 720',
                      ),
                    ),
