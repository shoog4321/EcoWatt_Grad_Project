...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _openEditDialog() {
    ...
    String? tempRegion = region.isNotEmpty ? region : null;
    String? tempHousing = housingType.isNotEmpty ? housingType : null;
    String? tempInsulation = insulation.isNotEmpty ? insulation : null;
    String? tempCooking = cookingFuel.isNotEmpty ? cookingFuel : null;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _EditDropdown(
                        ...
                        validator: (value) {
                          if (value == null || value.isEmpty) return 'Housing type is required';
                          return null;
                        },
                      ...
                      _EditTextField(
                        ...
                        validator: (value) {
                          ...
                          if (number <= 0) return 'Residents must be at least 1';
                      ...
                      _EditDropdown(
                        ...
                        items: const ['Yes', 'No'],
                        validator: (value) {
                          if (value == null || value.isEmpty) return 'Insulation is required';
                          return null;
                        },
                      ...
                      _EditLabel('AC Type'),
                        _FormCheckboxGroup(
                          selectedValues: tempAc.isEmpty
                              ? []
                              : tempAc.split(', ').map((e) => e.trim()).toList(),
                          items: const [
                            'Split AC',
                            'Window AC',
                            'Central AC',
                      ...
                      _EditDropdown(
                        ...
                        validator: (value) {
                          if (value == null || value.isEmpty) return 'Cooking fuel is required';
                          return null;
                        },
